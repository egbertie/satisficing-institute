...
# Configuration
SKILL_NAME = "error-guard"
LOG_DIR = Path("logs")
REPORT_DIR = Path("reports")


class ErrorGuardRunner:
    """Main runner class for error-guard"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Error guard for handling and logging system errors")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Error guard for handling and logging system errors",
