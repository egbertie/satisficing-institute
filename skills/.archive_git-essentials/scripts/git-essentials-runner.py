...
# Configuration
SKILL_NAME = "git-essentials"
LOG_DIR = Path("logs")
REPORT_DIR = Path("reports")


class GitEssentialsRunner:
    """Main runner class for git-essentials"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Git essentials for common operations")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Git essentials for common operations",
