...
# Configuration
SKILL_NAME = "feishu-doc-manager"
LOG_DIR = Path("logs")
REPORT_DIR = Path("reports")


class FeishuDocManagerRunner:
    """Main runner class for feishu-doc-manager"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Feishu document manager for Lark document operations")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Feishu document manager for Lark document operations",
