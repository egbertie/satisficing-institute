...
class EmailDailySummaryRunner:
    """Main runner class for email-daily-summary"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Email daily summary generator for inbox management")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Email daily summary generator for inbox management",
    ...
    runner = EmailDailySummaryRunner()
