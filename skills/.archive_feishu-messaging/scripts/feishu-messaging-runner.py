...
# Configuration
SKILL_NAME = "feishu-messaging"
LOG_DIR = Path("logs")
REPORT_DIR = Path("reports")


class FeishuMessagingRunner:
    """Main runner class for feishu-messaging"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Feishu messaging integration for notifications")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Feishu messaging integration for notifications",
