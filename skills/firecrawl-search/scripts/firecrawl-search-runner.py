...
class FirecrawlSearchRunner:
    """Main runner class for firecrawl-search"""
    ...
    def _cmd_run(self, args: argparse.Namespace) -> int:
        ...
        print(f"\n🚀 Running {SKILL_NAME}...")
        print(f"Description: Firecrawl search for web content extraction")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Firecrawl search for web content extraction",
